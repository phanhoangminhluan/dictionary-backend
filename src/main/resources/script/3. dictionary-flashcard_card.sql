...
CREATE TABLE `card` (
  ...
  `remember_count` int(11) DEFAULT NULL,
  `forget_count` int(11) DEFAULT NULL,
  `card_set_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `card_card_set_id_fk` (`card_set_id`),
  CONSTRAINT `card_card_set_id_fk` FOREIGN KEY (`card_set_id`) REFERENCES `card_set` (`id`)
...
INSERT INTO `card` VALUES ('1','Tra My','Is Luan\'s girlfriend',9999,0,NULL),('2','Minh Luan','Is My\'s boyfriend',9999,0,NULL);
...
-- Dump completed on 2020-02-05 21:56:51
